...
<Playground>
  <Replay
    source={{ streamUrl: 'https://d3sifrqo4fwaek.cloudfront.net/1920x1080/manifest.m3u8', startPosition: 2 }}
...
The main Replay project is not intended to offer and maintain any feature. In general, Replay is ready for adding most kinds of customisations or extensions. Here are some features and capabilities that can be added, but is out of scope for this project: 
