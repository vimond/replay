...
A React video player wrapping advanced streaming libraries while embracing modern React patterns.
...
* Consistent and predictable behaviour across browsers and stream technologies, to a practical extent.
