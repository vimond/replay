...
<Playground>
  <Replay
    source="https://s3.amazonaws.com/expo-first-vpc-vod-fragments/786e3/master_12903_64ee(12903_ISMUSP).ism/master_12903_64ee(12903_ISMUSP).m3u8"
    initialPlaybackProps={{ isPaused: true }}
    options={{ videoStreamer: { hlsjs: { customConfiguration: { startLevel: 3 }}}}}>
    <HlsjsVideoStreamer/>
  </Replay>
</Playground>
