...
Minimum React version for Replay is 16.3. If using the [video streamer resolver](/advanced-playback/adaptive-streaming#enabling-playback-for-multiple-streaming-technologies-based-on-stream-technology-resolution), React 16.6 is required. In this case, a bundler supporting dynamic `import()` statements, is also required.
