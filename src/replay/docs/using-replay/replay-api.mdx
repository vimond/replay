...
When a video source is loaded, the playback startup will have any of these properties applied, if they are specified:
...
Manipulates properties of the playback. The object argument can contain one or more of the properties found in `PlaybackProps`.
