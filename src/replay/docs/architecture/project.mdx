...
These steps will be improved and automated in the future. They are also part of the automated build, which means the push will lead to failing builds if errors are not fixed before push.