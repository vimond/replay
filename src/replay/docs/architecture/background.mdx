...
* The bitrate changes adaptively because of varying network conditions. 
...
## The multi-faceted and complex task of rendering and playing a video stream
...
## The player controller and its nice React fit
