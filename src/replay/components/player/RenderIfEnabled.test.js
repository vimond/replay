...
test(
  '<RenderIfEnabled /> only renders elements with names in the configuration when specified. It ignores the ' +
    '"Connected" part of a control name when matching with configuration.',
  () => {
