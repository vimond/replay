...
# Position preview tooltip for timeline

When the mouse pointer is over the timeline, displays the corresponding stream position or time-of-day clock time for the pointer position.
